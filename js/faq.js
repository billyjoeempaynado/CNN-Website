...
accordion_item.forEach((item) => {
  const accordion_header_item = item.querySelector(".accordion-heading");
...
function VerifyActive(item, content, content_actived) {
  const icon_item = item.querySelector(".accordion-icon");
  const icon_item_active = document.querySelectorAll(".accordion-icon");
